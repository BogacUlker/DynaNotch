...
enum FloatingTabConstants {
    ...
    static let collapsedSize = CGSize(width: 200, height: 4)
    /// Corner radius when the floating tab is expanded.
    static let expandedCornerRadius: CGFloat = 16.0
    /// Corner radius when the floating tab is collapsed (thin pill).
    static let collapsedCornerRadius: CGFloat = 2.0
}
